...
char *ssl_retrieve_response(SSL *ssl, unsigned long *size = nullptr);
char *ssl_retrieve_url_data(const char *url, unsigned long *size = nullptr);
char *ssl_download(const char *url, unsigned long *size);
